      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/pricing" className="hover:text-violet-600">
                Pricing
              </Link>
            </li>
            <li>
              <Link to="/aboutus" className="hover:text-violet-600">
                About Us
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/cookie-policy" className="hover:text-violet-600">
                Cookie Policy
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start space-x-4 text-xl text-gray-600">
            <a href="#" aria-label="Twitter" className="hover:text-violet-600">
              <FaTwitter />
            </a>
            <a href="#" aria-label="LinkedIn" className="hover:text-violet-600">
              <FaLinkedin />
            </a>
            <a href="#" aria-label="GitHub" className="hover:text-violet-600">
              <FaGithub />
            </a>
          </div>
        </div>
